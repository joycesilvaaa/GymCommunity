...
export function ExpiringDietCard({ title, description, navigation,  dietId, iconName, userId}: ExpiringDietCardProps){
  return (
    <Box p={3} bg="white" mb={4} shadow={1} borderRadius={10}>
        <VStack space={3}>
          ...
          <HStack justifyContent="space-between" alignItems="center">
            <Pressable onPress={() => navigation.navigate("ViewDiet", { id: dietId })}>
